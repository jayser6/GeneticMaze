...
{
    public class TurretProjectileStandard : ProjectileBase
    {
        ...
        private void Start()
        {
            ...
            if (turret.GetComponent<Health>().CurrentHealth < (turret.GetComponent<Health>().MaxHealth/2))
            {
                Damage = Damage * 2;
                Debug.Log(turret.GetComponent<Health>().CurrentHealth + " < " + (turret.GetComponent<Health>().MaxHealth / 2));
            } else
            {
                Debug.Log("keep dmg");
            }
