...
namespace Unity.FPS.AI
{
    ...
    public class PetEnemyController : MonoBehaviour
    {
        [System.Serializable]
        ...
        public GameObject KnownDetectedTarget => PetDetectionModule.KnownDetectedTarget;
        public bool IsTargetInAttackRange => PetDetectionModule.IsTargetInAttackRange;
        public bool IsSeeingTarget => PetDetectionModule.IsSeeingTarget;
        public bool HadKnownTarget => PetDetectionModule.HadKnownTarget;
        public NavMeshAgent NavMeshAgent { get; private set; }
        public PetDetectionModule PetDetectionModule { get; private set; }
        ...
        void Start()
        {
            ...
            var detectionModules = GetComponentsInChildren<PetDetectionModule>();
            DebugUtility.HandleErrorIfNoComponentFound<PetDetectionModule, EnemyController>(detectionModules.Length, this,
                gameObject);
            DebugUtility.HandleWarningIfDuplicateObjects<PetDetectionModule, EnemyController>(detectionModules.Length,
                this, gameObject);
            // Initialize detection module
            PetDetectionModule = detectionModules[0];
            PetDetectionModule.onDetectedTarget += OnDetectedTarget;
            PetDetectionModule.onLostTarget += OnLostTarget;
            onAttack += PetDetectionModule.OnAttack;
        ...
        void Update()
        {
            ...
            PetDetectionModule.HandleTargetDetection(m_Actor, m_SelfColliders);
        ...
        void OnDamaged(float damage, GameObject damageSource)
        {
            ...
            {
                // pursue the player
                PetDetectionModule.OnDamaged(damageSource);
        ...
        void OnDrawGizmosSelected()
        {
            ...
            if (PetDetectionModule != null)
            {
                // Detection range
                Gizmos.color = DetectionRangeColor;
                Gizmos.DrawWireSphere(transform.position, PetDetectionModule.DetectionRange);

                // Attack range
                Gizmos.color = AttackRangeColor;
                Gizmos.DrawWireSphere(transform.position, PetDetectionModule.AttackRange);
            }
        }
